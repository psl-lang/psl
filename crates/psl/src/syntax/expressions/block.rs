...
use crate::{
    ast::{Block, BlockExpression, Statement, TokenKind},
    syntax::{fragments::separator::parse_separator, statements::parse_statement},
};

pub fn parse_block(s: &mut Located<&str>) -> PResult<BlockExpression> {
    delimited(
    ...
    .map(|statements: Vec<_>| {
        BlockExpression(match &statements[..] {
